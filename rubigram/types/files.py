...
async def _download_bound_file(target: Object, *, path: Any, in_memory: bool, file_name: Optional[str], progress: Any, progress_args: tuple[Any, ...], missing_message: str) -> Any:
    if target._client is None:
        raise RuntimeError(missing_message)
    return await target._client.download_file(target, path=path, in_memory=in_memory, file_name=file_name, progress=progress, progress_args=progress_args)


async def _download_bound_url(target: Object, *, path: Any, in_memory: bool, file_name: Optional[str], progress: Any, progress_args: tuple[Any, ...], missing_message: str) -> Any:
    if target._client is None:
        raise RuntimeError(missing_message)
...
class DownloadableFile(Object):
    ...
    async def download(self, path: Any = None, *, in_memory: bool = False, file_name: Optional[str] = None, progress: Any = None, progress_args: tuple[Any, ...] = ()) -> Any:
        ...
        return await _download_bound_file(self, path=path, in_memory=in_memory, file_name=file_name, progress=progress, progress_args=progress_args, missing_message="This file is not bound to a Client instance")
...
class AvatarThumbnail(DownloadableFile):
    async def download(self, path: Any = None, *, in_memory: bool = False, file_name: Optional[str] = None, progress: Any = None, progress_args: tuple[Any, ...] = ()) -> Any:
        return await _download_bound_file(self, path=path, in_memory=in_memory, file_name=file_name, progress=progress, progress_args=progress_args, missing_message="This avatar is not bound to a Client instance")
...
class Avatar(Object):
    ...
    async def download(self, path: Any = None, *, in_memory: bool = False, file_name: Optional[str] = None, progress: Any = None, progress_args: tuple[Any, ...] = (), use_thumbnail: bool = False) -> Any:
        ...
        return await file.download(path=path, in_memory=in_memory, file_name=file_name or self._default_download_name(use_thumbnail=use_thumbnail), progress=progress, progress_args=progress_args)
...
class ChatAvatars(Object):
    ...
    async def download(self, path: Any = None, *, in_memory: bool = False, progress: Any = None, progress_args: tuple[Any, ...] = (), use_thumbnail: bool = False) -> list[Any]:
        """Download every avatar, naming files ``<avatar_id>_<role>.<ext>``."""
        results = []
        for index, avatar in enumerate(self.avatars, start=1):
            results.append(await avatar.download(path=path, in_memory=in_memory, file_name=avatar._default_download_name(use_thumbnail=use_thumbnail, index=index), progress=progress, progress_args=progress_args, use_thumbnail=use_thumbnail))
        return results
...
class UrlFile(Object):
    ...
    async def download(self, path: Any = None, *, in_memory: bool = False, file_name: Optional[str] = None, progress: Any = None, progress_args: tuple[Any, ...] = ()) -> Any:
        return await _download_bound_url(self, path=path, in_memory=in_memory, file_name=file_name, progress=progress, progress_args=progress_args, missing_message="This URL file is not bound to a Client instance")
