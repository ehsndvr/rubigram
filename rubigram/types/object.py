...
class Object:
    ...
    def bind(self, client: "rubigram.Client") -> None:
        """Bind a Client instance to this and to all nested rubigram objects.

        Parameters:
            client (:obj:`~rubigram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing rubigram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/rubigramchat/167281
